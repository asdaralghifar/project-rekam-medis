...
<?php
         ...
         {
           $sql="INSERT INTO `table_regis` (`namapengguna`, `namalengkap`, `jeniskelamin`, `email`, `phone`, `alamat`, `sandi`)
           VALUES ('$_GET[namapengguna]', '$_GET[namalengkap]', '$_GET[jeniskelamin]', '$_GET[email]', '$_GET[phone]', '$_GET[alamat]', MD5('$_GET[sandi]'));";
           mysqli_query ($con,$sql);
           $sql="INSERT INTO `table_admin` (`namapengguna`, `sandi`, `level`)
           VALUES ('$_GET[namapengguna]', MD5('$_GET[sandi]'), 'pengguna');";
           mysqli_query ($con,$sql);
         }
?>
